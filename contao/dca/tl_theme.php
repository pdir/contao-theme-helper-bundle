 ...
 */
$GLOBALS['TL_DCA']['tl_theme']['fields']['pdir_th_description'] = [
...
$GLOBALS['TL_DCA']['tl_theme']['fields']['pdir_th_license_domain'] = [
    'label' => &$GLOBALS['TL_LANG']['tl_theme']['pdir_th_license_domain'],
    'exclude' => true,
    'inputType' => 'text',
    'eval' => ['tl_class' => 'w50', 'maxlength' => 128, 'readonly' => true],
    'sql' => "varchar(128) NOT NULL default ''",
];

$GLOBALS['TL_DCA']['tl_theme']['fields']['pdir_th_short_code'] = [
